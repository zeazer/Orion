...
void EmptyLinkFunctionForGeneratedCodeOrionUI_init() {}
	...
	ORIONUI_API UFunction* Z_Construct_UDelegateFunction_OrionUI_TimerFinished__DelegateSignature();
	ORIONUI_API UFunction* Z_Construct_UDelegateFunction_OrionUI_TimerUdpate__DelegateSignature();
...
FORCENOINLINE UPackage* Z_Construct_UPackage__Script_OrionUI()
{
	if (!Z_Registration_Info_UPackage__Script_OrionUI.OuterSingleton)
	{
		static UObject* (*const SingletonFuncArray[])() = {
			...
			(UObject* (*)())Z_Construct_UDelegateFunction_OrionUI_TimerFinished__DelegateSignature,
			(UObject* (*)())Z_Construct_UDelegateFunction_OrionUI_TimerUdpate__DelegateSignature,
		};
...
static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_OrionUI(Z_Construct_UPackage__Script_OrionUI, TEXT("/Script/OrionUI"), Z_Registration_Info_UPackage__Script_OrionUI, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x464CF4E3, 0x617CE87B));
